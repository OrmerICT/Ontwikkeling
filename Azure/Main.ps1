...
##################################
#Stage 2 - Create Storage Account
##################################

#Troubleshooting messages
Write-Verbose "$(Get-Date -f T) - Creating $($StorageAccountName) storage account"
Write-Debug "About to create $($StorageAccountName) storage account"
...
##################################
#Stage 4 - Create Virtual Network
##################################
